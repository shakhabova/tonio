export function jsGlobe() {
  ...
  var props = {
    ...
    colours: {
      // Cache the colours
      globeDots: "#434343", // No need to use the Three constructor as this value is used for the HTML canvas drawing 'fillStyle' property
      // purple rgb(95, 41, 170)
      lines: new THREE.Color("#434343"),
      lineDots: new THREE.Color("#434343"),
    },
    alphas: {
